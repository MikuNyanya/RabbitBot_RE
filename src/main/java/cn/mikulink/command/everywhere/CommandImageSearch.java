...
//        }
        ...
        //我真看不太懂kotlin，先凑合着用吧,真正的对象是net.mamoe.mirai.qqandroid.message.OnlineGroupImageImpl，但代码报红，虽然可以运行，提示Usage of Kotlin internal declaration from different module
        ...
        try {
            return imageService.searchImgFromSaucenao(imgUrl, subject);
