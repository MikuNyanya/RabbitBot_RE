package cn.mikulink.rabbitbot.sys;
...
public class AnnotateScanner implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        if (event.getApplicationContext().getParent() == null) {
            Map<String, Object> beans = event.getApplicationContext().getBeansWithAnnotation(cn.mikulink.rabbitbot.sys.annotate.Command.class);
